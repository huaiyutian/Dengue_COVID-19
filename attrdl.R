...
#
  # EXTRACT NAME AND CHECK type AND dir 提取名称和检查类型和目录
...
#  
  # SELECT RANGE (FORCE TO CENTERING VALUE OTHERWISE, MEANING NULL RISK) 选择范围(强制将值居中，否则意味着零风险)
...
#
  # COMPUTE AF AND AN 
  #drop(as.matrix(Xpredall%*%coef)： β
